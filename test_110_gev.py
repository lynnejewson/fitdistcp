...
def reltest_to_file():
    ...
    with open('reltest output/reltest GEV 6.txt', 'w') as f:
        json.dump(result, f)
...
x_example_2 = [
    0.20572726, 1.86384593, 0.48910372, 1.43486757, 1.159838, 0.15611357, 0.94287216, 
    0.03497607, 0.5713605,  1.1172626,  0.6266541,  1.23199102, 0.96530044, 2.0140288,  
    0.37606083, 0.62832804, 1.07610164, 1.15995558, 0.10547796, 0.65184389
]
x = genextreme.rvs(0.3, loc=5, scale=1, size=50)
