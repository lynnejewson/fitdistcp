...
# vectorised versions of the above functions:
...
def gev_f2fa(x, v1, v2, v3):
    v3 = cp_utils.movexiawayfromzero(v3)
    temp1 = gev_fdd(x, v1, v2, v3)
    f2 = cp_utils.deriv_copyfdd(temp1, len(x), dim=3)
    return f2
...
def gev_mu2fa(alpha, v1, v2, v3):
    x = genextreme.ppf((1-alpha), -v3, loc=v1, scale=v2)
    v3 = cp_utils.movexiawayfromzero(v3)
    temp1 = gev_pdd(x, v1, v2, v3)
    mu2 = -cp_utils.deriv_copyfdd(temp1, len(x), dim=3)
    return mu2
...
def gev_ldda(x, v1, v2, v3):
    ...
    ldd = cp_utils.deriv_copyldd(temp1, len(x), dim=3)
    return ldd
...
def gev_lddda(x, v1, v2, v3):
    ...
    lddd = cp_utils.deriv_copylddd(temp1, len(x), dim=3)
    return lddd
...
def gev_ld12a(x, v1, v2, v3):
    ...
    temp2 = gev_logfdd(x,v1,v2,v3)
    ld2 = cp_utils.deriv_copyld2(temp2, nx, dim=3)
    dim = 3
